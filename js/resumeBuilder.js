...
var education = {
    ...
    display: function() {
        ...
        if (education.onlineCourses.length > 0) {
            ...
            for (var q = 0; q < education.onlineCourses.length; q++) {
                var formattedonlineTitle = HTMLonlineTitle.replace("%data%", education.onlineCourses[q].title);
                var formattedonlineSchool = HTMLonlineSchool.replace("%data%", education.onlineCourses[q].school);
                var formattedonlineDates = HTMLonlineDates.replace("%data%", education.onlineCourses[q].dates);
                var formattedonlineURL = HTMLonlineURL.replace("%data%", education.onlineCourses[q].url);
